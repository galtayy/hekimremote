...
class HekimremoteImpl implements Hekimremote {
  final HekimremotePlatform _platform;
  factory HekimremoteImpl(ExternalLibrary dylib) =>
      HekimremoteImpl.raw(HekimremotePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory HekimremoteImpl.wasm(FutureOr<WasmModule> module) =>
      HekimremoteImpl(module as ExternalLibrary);
  HekimremoteImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
class HekimremotePlatform extends FlutterRustBridgeBase<HekimremoteWire> {
  HekimremotePlatform(ffi.DynamicLibrary dylib) : super(HekimremoteWire(dylib));
...
class HekimremoteWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  HekimremoteWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  HekimremoteWire.fromLookup(
